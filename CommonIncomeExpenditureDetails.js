    ...
    $('#IncomeExpenditureSheet').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                pageSize: 'A4',
                extend: 'pdfHtml5',
                filename: 'Common Income and Expenditure Details_' + now.getDate() + '-' + (now.getMonth() + 1) + '-' + now.getFullYear(),
                title: 'Export',
                header: true,
                customize: function (doc) {
                    doc.content.splice(0, 1, {
                        text: [{
                            ...
                            text: 'Common Income&Expenditure Details From(' + fromDate.getDate() + '/' + (fromDate.getMonth() + 1) + '/' + fromDate.getFullYear() + '-' + toDate.getDate() + '/' + (toDate.getMonth() + 1) + '/' + toDate.getFullYear() + ')',
                            bold: true,
                            fontSize: 11
                        }],
                        margin: [0, 0, 0, 12],
            ...
            },
            {
                ...
                message: "<div class='row'><h3 class='text-center'>Khalsa College Charitable Society, Amritsar</h3></div>" +
                    ...
                    "<div class='row exportoption'><h4 class='text-center'>Common Income&Expenditure Details  From ( " + fromDate.getDate() + "/ " + (fromDate.getMonth() + 1) + "/ " + fromDate.getFullYear() + " -  " + toDate.getDate() + "/ " + (toDate.getMonth() + 1) + "/ " + toDate.getFullYear() + ")</h4></div> ",
        ...
        ajax: {
            url: "GenerateCommonIncomeExpenditureDetails",
...
function bindExpenditureDetails(fromDate, toDate, instituteId) {
    ...
    $.ajax({
        type: "POST",
        url: '/Reports/CreateLedgerCommonIncomeExpenditute',
        contentType: "application/json; charset=utf-8",
    ...
    $('#tblExpenditureDetails').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                pageSize: 'A4',
                extend: 'pdfHtml5',
                filename: 'Common Income Expenditure_' + now.getDate() + '-' + (now.getMonth() + 1) + '-' + now.getFullYear(),
                title: 'Export',
                header: true,
                customize: function (doc) {
                    doc.content.splice(0, 1, {
                        text: [{
                            ...
                            text: 'Common Income Expenditure From(' + fromDate.getDate() + '/' + (fromDate.getMonth() + 1) + '/' + fromDate.getFullYear() + '-' + toDate.getDate() + '/' + (toDate.getMonth() + 1) + '/' + toDate.getFullYear() + ')',
                            bold: true,
                            fontSize: 11
                        }],
                        margin: [0, 0, 0, 12],
            ...
            },
            {
                ...
                message: "<div class='row'><h3 class='text-center'>Khalsa College Charitable Society, Amritsar</h3></div>" +
                    "<div class='row exportoption'><h4 class='text-center'>" + userData.InstName + "</h4></div>" +
                    "<div class='row exportoption'><h4 class='text-center'>Common Income Expenditure From (" + fromDate.getDate() + '/' + (fromDate.getMonth() + 1) + '/' + fromDate.getFullYear() + ' - ' + toDate.getDate() + '/' + (toDate.getMonth() + 1) + '/' + toDate.getFullYear() + ")</h4></div> ",
                orientation: 'landscape',
                pageSize: 'LEGAL',
                footer: true,
                customize: function (win) {
